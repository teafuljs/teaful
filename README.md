...
| name                  | type       | description                                                                                                                                                                                                                                    | example                                                                                                                                                                                                                    |
| --------------------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Initial value         | `any`      | This parameter is **not mandatory**. It only makes sense for new store properties that have not been defined before within the `createStore`. If the value has already been initialized inside the `createStore` this parameter has no effect. **Only** in the case of `useStore({ count: 1 })` even if there is a store in `createStore` it does an `Object.assign` of the parameter and what is in the store. That is to say, that if the `count` did not exist it puts it, without changing the rest of existing properties.  | `const [price, setPrice] = useStore.cart.price(0)`                                                                                                                                                                         |
