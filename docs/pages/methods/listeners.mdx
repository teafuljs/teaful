# onAfterUpdate Listeners

Using onAfterUpdate listeners, you can listen to changes in the store. This can be useful for validating properties, storing error messages, optimistic updates, etc...

# Two Types of Listeners

## Permanent events listeners
